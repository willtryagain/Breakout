...
class Boss(Meta):
    ...
    #     self._ascii = self._repr = np.array([[' ', Style.BRIGHT + Fore.RED + '<', Style.BRIGHT + Fore.RED + '>', Style.BRIGHT + Fore.RED + '=', Style.BRIGHT + Fore.RED + '=', Style.BRIGHT + Fore.RED + '=', Style.BRIGHT + Fore.RED + '=', Style.BRIGHT + Fore.RED + '=', Style.BRIGHT + Fore.RED + '=', Style.BRIGHT + Fore.RED + '=', Style.BRIGHT + Fore.RED + '(',
